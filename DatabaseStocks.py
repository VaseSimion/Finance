...
investing_list_of_energy = ["ADES", "AES", "ARPL", "AMRC", "AMSC", "APA", "ARCH", "AROC", "BKR", "BLDP", "BSM", "BCEI",
                            ...
                            "ETR", "EDP", "EVA", "EOG", "EQT", "EQNR", "ES", "EXC", "EXTN",
...
investing_list_of_materials = ["MMM", "ASIX", "AEM", "AIV", "ADP", "ALB", "AA", "AMCR", "AU", "AVY", "BCPC", "BLL",
                               "GOLD", "BBL", "BHP", "BCC", "BREE", "CCJ", "CSL", "CSR", "CE", "CF", "CLF", "CDXS",
                               "BVN", "DOW", "DRD",
                               ...
                               "SCOO", "STLD", "MOS", "TREX", "URG", "UEC", "VVV", "VRS", "VMC", "WRK", "WMP", "AUY"]
...
investing_list_of_industrials = ["AOS", "AIR", "ATU", "ADSW", "AEIS", "ACM", "AVAV", "ALG", "ALRM", "ALK", "ALGT",
                                 ...
                                 "BLNK", "BE", "BA", "BGG", "CHWR", "WHD", "CAI", "CAMT", "CNI", "CARR", "CAT", "CFX",
...
investing_list_of_consumer_discretionary = ["FLWS", "TWOU", "AAN", "ANF", "ACTG", "ACCO", "AEY", "ADNT", "ATGE", "AAP",
                                            ...
                                            "DLPH", "DENN", "DKS", "DPZ", "DKNG", "EBAY", "ECL", "LOCO", "EEX", "ETSY",
                                            ...
                                            "NIO", "JWN", "NCHL", "ORLY", "OSW", "OSTK", "PTON", "PENN", "PETQ", "PETS",
...
investing_list_of_consumer_staples = ["MO", "BUD", "ADM", "BGS", "BYND", "BIG", "BJ", "BTI", "BF", "BG", "CALM", "CVGW",
                                      "CPB", "CELH", "CHD", "CLX", "KO", "CCEP", "CL", "CAG",
...
investing_list_of_healthcare = ["TXG", "ABT", "ABBV", "ABMD", "ACIU", "ACHC", "ACAD", "AXDX", "XLRN", "ACOR", "AHCO",
                                ...
                                "CBPO", "CPHI", "CI", "CLIN", "CLVS", "CODX", "COCP", "CHRS", "COLL", "CGEN", "CNST",
...
investing_list_of_financials = ["SRCE", "QFIN", "JFU", "AER", "AMG", "AFL", "AGMH", "AGNC", "AIG", "AL", "ALEX", "ADS",
                                ...
                                "AMTD", "TCBI", "TFSL", "BX", "THG", "TRV", "TPRE", "TSBK", "TD", "SHLL", "TOWN", "TSC",
                                "TFC", "TRUP", "TWO", "USB", "UMBF", "UMPQ", "UBSI", "UIHC", "UVE", "UNM", "VLY", "VEL",
                                "VCTR", "VBFC", "VIRT", "V", "WAFD", "WSBF", "WSB", "WFC", "WAL", "WNEB", "WU", "WHG",
                                "WLTW", "WTFC", "XP", "ZION"]
...
investing_list_of_technology = ["ONEM", "DDD", "ATEN", "ACN", "ACIW", "ATVI", "ADBE", "ADTN", "AMD", "AGYS", "API",
                                ...
                                "BNFT", "BILI", "BILL", "BLKB", "BB", "BL", "BAH", "BROS", "EPAY", "BOX", "BCOV",
                                ...
                                "EA",
                                "EMKR", "EMIS", "DAVA", "EIGI", "ENV", "EPAM", "PLUS", "EFX", "ERIC", "EVBG", "MRAM",
                                ...
                                "HUBS", "HUYA", "IBM", "IDEA", "IDEX", "INVE", "IDOX", "INFO", "IIVI", "IMMR", "INFN",
                                "INOV", "IPHI", "INPX", "INSG", "NSIT", "INSE", "INTC", "IDCC", "INTU", "IPGP", "IQE",
                                "JCOM", "JBL", "JNPR", "KLAC",
                                ...
                                "SSNC", "SRT", "SSYS",
                                "SMCI", "SVMK", "SYKE", "SYNC", "SYNA", "SNCR", "SNX", "SNPS", "THRC", "TSM", "TTWO",
                                "TLND", "TM17", "TENB", "TDC",
                                "TER", "TXN", "TIVO", "TSEM", "TRU", "TTEC", "TTMI", "TWLO", "TYL", "UI", "UCTT", "UIS",
                                "UMC", "OLED", "UPLD", "UTSI",
                                "VRNS", "VECO", "VEEV", "VRNT", "VRSK", "VERI", "VSAT", "VIAV", "VICR", "VRTU", "VISL",
                                "VMW", "VCRA", "VOXX", "VUZI", "WAND", "WDC", "WIT", "WNS",
                                "WDAY", "WK", "XRX", "XLNX", "XPER", "XNET", "YEXT", "ZBRA", "ZEN", "ZUO", "ZNGA", "ZS"]

investing_list_of_communication_services = ["VNET", "EGHT", "ACIA", "ALLT", "GOOGL", "GOOG", "ANGI", "T", "ANTI",
                                            ...
                                            "IRDM", "KVHI", "LBRD", "LBTY", "LILA", "LTRPA", "LGF-B", "LORL",
...
investing_list_of_utilities_and_real_estate = ["AQN", "ALE", "LNT", "AEE", "AEP", "AWR", "AWK", "ATO", "AGR", "AVA",
                                               ...
                                               "ESRT", "EQIX", "ELS", "EQR", "ESS", "EXPI", "EXR", "FPIPB",
